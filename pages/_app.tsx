...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return <Fragment>
    <Head>
      <title>/home/tamlam{page ? "/" + page : ""}</title>
      <link rel="icon" href="/favicon.ico" />
      <script async defer data-domain="tamlam.rocks" src="https://analytics.tamlam.rocks/js/plausible.js"></script>
    ...
    <div className="flex justify-center items-center bg-gray-100 h-16">
      <div className="container-center center-horizontal text-slate-500 font-bold">
        <Link href="/">
          <a className="font-bold text-gray-700">/home/tamlam</a>
        </Link>
        {page ? "/" + page : ""}
