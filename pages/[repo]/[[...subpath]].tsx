...
const Devlog: NextPage = ({ markdown, postTitle, repo, subpath }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  content = content.replace(/src=\"(.\/)?/g, `src="https://raw.githubusercontent.com/lamngoctam/${repo}/master/`);
  ...
  const pageTitle = "/home/tamlam/" + repo + (postTitle ? ` | ${postTitle}` : "");
  ...
  const socialImage = postTitle ? `https://tamlam.rocks/api/image?t=${base64_encode(postTitle)}` : 'https://tamlam.rocks/social-image.png';
    ...
    <>
      ...
      {!subpath && (
        <>
            ...
            <div className="my-2 text-gray-500">-&gt; <Link href={`https://github.com/lamngoctam/${repo}`}><a className="hover:underline">GitHub Repository</a></Link></div>
        </>
      )}
